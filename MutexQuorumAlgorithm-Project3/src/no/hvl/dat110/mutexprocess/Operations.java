...
/**
 * The class handles the actual read and write requests and operations from the
 * client processes
 *
 */
	...
	public void multicastOperationToReplicas(Message message) throws AccessException, RemoteException {
		...
		for (int i = 0; i < replicas.size(); i++) {
			...
			try {
				...
				// System.out.println(message.getProcessStubName()+":
				// "+message.getOptype().toString()+" multicast to "+stub);
